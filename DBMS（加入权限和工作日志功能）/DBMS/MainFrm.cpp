...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	{//游客
		...
		GetMenu()->GetSubMenu(2)->EnableMenuItem(1, MF_BYPOSITION | MF_DISABLED);
		GetMenu()->GetSubMenu(2)->EnableMenuItem(2, MF_BYPOSITION | MF_DISABLED);
		...
		GetMenu()->GetSubMenu(3)->EnableMenuItem(2, MF_BYPOSITION | MF_DISABLED);

...
#if !defined(AFX_MESSAGE_H__C6AE3016_FC04_4AA3_AB6C_4472BAADEFEB__INCLUDED_)
#define AFX_MESSAGE_H__C6AE3016_FC04_4AA3_AB6C_4472BAADEFEB__INCLUDED_
...
public:
	...
	char m_chAccount[ACCOUNTLEN];	//帐户ID
	char m_chPassword[PASSWRODLEN];	//登录密码
	char m_chContent[CONTENTLEN];	//消息长度
	int m_nAccountID[MAXACCOUNT];	//对方帐户ID
	int m_nSrcID;					//发送消息的源帐户ID
...
#endif // !defined(AFX_MESSAGE_H__C6AE3016_FC04_4AA3_AB6C_4472BAADEFEB__INCLUDED_)
